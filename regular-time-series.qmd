...
For this example we set ```k = 0``` and ```nw = 0``` to switch-off tapering in the spectrum estimation. 
```{r}
sp1_10k <- SpecACF(ts(dat$y, deltat = 1), bin.width = 1, k = 0, nw = 0, detrend = FALSE)
sp1_10k_detr <- SpecACF(ts(dat$y, deltat = 1), bin.width = 1, k = 0, nw = 0, detrend = TRUE)
...
```{r}
sp1_0.5k <- SpecACF(ts(dat_500$y, deltat = 1), bin.width = 1, k = 0, nw = 0, detrend =  FALSE)
sp1_0.5k_detr <- SpecACF(ts(dat_500$y, deltat = 1), bin.width = 1, k = 0, nw = 0, detrend =  TRUE)
...
sp1_res <- SpecACF(dat_500$res_sine, bin.width = 1, k = 0, nw = 0)
...
mean_spec <- SpecACF(ts_m, bin.width = 1, k = 0, nw = 0, detrend = FALSE)
